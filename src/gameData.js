...
export const levelPresets = [
  { id: "level_1", name: "第一关：入塔试炼", bossPersona: "gatekeeper", playerMaxHp: 18, bossMaxHp: 16, weather: "clear", revealCount: 1, initialBuffs: [], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "maid", "thief"], selectedMoves: ["single_win", "double_win", "counter"], selectedBossMoves: ["boss_single"], ownedItems: ["peek", "plus_half", "minus_half", "save"] },
  { id: "level_2", name: "第二关：护卫巡逻", bossPersona: "sentinel", playerMaxHp: 18, bossMaxHp: 20, weather: "rain", revealCount: 1, initialBuffs: ["player_hp_plus"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "guard", "maid", "thief"], selectedMoves: ["single_win", "double_win", "counter"], selectedBossMoves: ["boss_single", "boss_bait"], ownedItems: ["peek", "plus_half", "minus_half", "plus_one"] },
  { id: "level_3", name: "第三关：雪花谋士", bossPersona: "strategist", playerMaxHp: 20, bossMaxHp: 24, weather: "hail", revealCount: 2, initialBuffs: ["xray_boost"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "maid", "thief", "noble", "snowflake"], selectedMoves: ["single_win", "double_win", "win_win_loss"], selectedBossMoves: ["boss_single", "boss_bait"], ownedItems: ["peek", "plus_half", "plus_one", "save"] },
  { id: "level_4", name: "第四关：四象门", bossPersona: "four_symbols", playerMaxHp: 22, bossMaxHp: 28, weather: "sun", revealCount: 2, initialBuffs: ["collapse_guard"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "guard", "four_qinglong", "four_baihu", "four_zhuque", "four_xuanwu"], selectedMoves: ["single_win", "double_win", "win_win_loss", "comeback"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait"], ownedItems: ["peek", "minus_half", "plus_one", "save"] },
  { id: "level_5", name: "第五关：伪神赌局", bossPersona: "gambler", playerMaxHp: 24, bossMaxHp: 32, weather: "clear", revealCount: 3, initialBuffs: ["random_commoner"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "queen", "noble", "false_god", "assassin", "fate", "shadow"], selectedMoves: ["single_win", "double_win", "counter", "comeback"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait"], ownedItems: ["peek", "plus_one", "minus_half", "save"] },
  { id: "level_6", name: "第六关：暖风终局", bossPersona: "executioner", playerMaxHp: 26, bossMaxHp: 36, weather: "warm", revealCount: 3, initialBuffs: ["player_move_plus", "random_king"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "guard", "noble", "queen", "strike_blade", "civilization", "final_moment", "rebel"], selectedMoves: ["single_win", "double_win", "win_win_loss", "counter"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait"], ownedItems: ["peek", "plus_half", "plus_one", "save"] },
  { id: "level_7", name: "第七关：王座决战", bossPersona: "king", playerMaxHp: 30, bossMaxHp: 42, weather: "clear", revealCount: 4, initialBuffs: ["chaotic_battlefield", "collapse_guard"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "guard", "noble", "queen", "strike_blade", "forge_blade", "civilization", "perfect_match"], selectedMoves: ["single_win", "double_win", "win_win_loss", "counter", "comeback"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait"], ownedItems: ["peek", "plus_one", "minus_half", "save"] }
];
