...
export const bossMoveLibrary = [
  ...
  { id: "boss_gamble_swing", name: "豪赌翻盘", pattern: ["draw", "win"], damage: 4, note: "赌徒在双方失败后抓住机会反打" },
...
export const levelPresets = [
  ...
  { id: "floor_5_boss", floor: 5, battleType: "boss", name: "第五层 Boss：伪神赌徒", bossPersona: "gambler", playerMaxHp: 24, bossMaxHp: 33, weather: "clear", revealCount: 3, initialBuffs: ["random_commoner"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "queen", "noble", "false_god", "assassin", "fate", "shadow", "thief"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait", "boss_grind", "boss_comeback", "boss_gamble_swing"], battleRule: { id: "gambler_draw_pressure", name: "赌神牌桌", text: "双方失败时，Boss 压力 +1。伪神赌徒会用刺客、命运、伪神制造双方失败和高波动回合。" }, bossSkills: [{ round: 2, name: "下注", effect: "bossMoveDamageBonus", value: 2, text: "Boss 下一次招式伤害 +2。" }, { round: 5, name: "强行加注", effect: "pressureUp", value: 2, text: "Boss 压力 +2。" }, { round: 8, name: "伪神降桌", effect: "ignoreNextBossLossSequence", value: 1, text: "Boss 下一次失败不增加玩家胜负序列。" }], ownedItems: ["peek", "plus_one", "minus_half", "save"] },
