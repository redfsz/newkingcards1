...
export const levelPresets = [
  ...
  { id: "floor_5_boss", floor: 5, battleType: "boss", name: "第五层 Boss：伪神赌徒", bossPersona: "gambler", playerMaxHp: 24, bossMaxHp: 32, weather: "clear", revealCount: 3, initialBuffs: ["random_commoner"], playerDeck: ["king", "minister", "commoner"], bossDeck: ["king", "minister", "commoner", "queen", "noble", "false_god", "assassin", "fate", "shadow"], selectedBossMoves: ["boss_single", "boss_double", "boss_bait", "boss_triple", "boss_grind", "boss_comeback"], battleRule: { id: "gambler_draw_pressure", name: "赌神牌桌", text: "双方失败时，Boss 压力 +1。" }, bossSkills: [{ round: 2, name: "下注", effect: "bossMoveDamageBonus", value: 1, text: "Boss 下一次招式伤害 +1。" }, { round: 5, name: "强行加注", effect: "pressureUp", value: 2, text: "Boss 压力 +2。" }, { round: 8, name: "伪神降桌", effect: "ignoreNextBossLossSequence", value: 1, text: "Boss 下一次失败不增加玩家胜负序列。" }], ownedItems: ["peek", "plus_one", "minus_half", "save"] },
